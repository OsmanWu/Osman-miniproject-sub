...
CREATE TABLE `hotel_bookings` (
  ...
  KEY `room_id` (`room_id`),
  CONSTRAINT `hotel_bookings_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`),
  CONSTRAINT `hotel_bookings_ibfk_2` FOREIGN KEY (`hotel_id`) REFERENCES `hotels` (`hotel_id`),
  CONSTRAINT `hotel_bookings_ibfk_3` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`room_id`)
